...
\label{transition}
{\scriptsize Notes: The figure shows the simulation of transition path after a reduction of automation cost with the calibrated model. Red lines show the transition with fixed human capital investment, blue lines show the transition with endogenous human capital investment. Oscillations are caused by the computational errors.}
\end{figure}

Figure \ref{transition} plots the simulation result of the transition path with calibrated model. The simulation with fixed human capital investment (scenario 1) is plotted with blue lines and the simulation with endogenous human capital (scenario 2) is plotted with red lines. A reduction of automation cost increases immediately the automation rate. However, the technology change increases the demand for capital but decrease the demand for both skilled and unskilled workers. As a result, the capital rental rate increases and wages decrease. This price changes increase the innovation patent value and decrease the automation patent value. The innovation rate starts to raise and the automation slows down, both rates converge to a higher level than the initial rates. 

In scenario 2 with endogenous human capital, the labor share initially drops more than scenario 1 with fixed human capital investment, due to higher human capital investment and lower labor supply. Once the innovation rate start to catch up, the labor share increases and reaches a level higher than scenario 1. The skilled workers accumulate their human capital faster than unskilled workers, the human capital gap keeps increasing and the wage premium grows faster than scenario 1.
...
\label{tax}
{\scriptsize Equal transfers to all the workers financed by alternative tax rates of the automation tax (blue lines) and the training tax on skilled workers (red lines). The figure shows predicted economic aggregates for new balanced growth path (after technological revolution) with calibrated model.}
\end{figure}
...
In the long run, automaton tax decreases the automation level and increases the labor share, less tasks are automated due to the lower automation patent profit. Lower automation level decreases the wage and welfare inequality. Training tax increases the automation level and decreases the labor share. The tax favors the automation and suppresses the human capital investment. However, the human capital growth rate is higher than aissez-faire rate. When the tax reduces the human capital investment, it decreases the opportunity cost of R\&D and increases the technology growth rate. Higher technology growth rate increases the wage growth rate and encourages more human capital investment. The training tax is more efficient in reducing the wage premium and welfare inequality. A small tax on training decreases significantly the human capital gap, favors a lot the unskilled workers. 

In the long run, consistent with the result of social planner's problem in section 4, both automation tax and training tax on skilled workers improve the efficiency of the economy and boost the long run growth. Automation tax corrects the positive externality of innovation on aggregate productivity; training tax on skilled workers corrects the negative externality on R\&D sector. However, the long run implication does not tell the whole story, I next plot the transition path while imposing taxes.  

\begin{figure}[h!]
\includegraphics[width=\textwidth]{Transition3}
\caption{Adjustment Dynamics (automation or training tax)}
\label{transition3}
{\scriptsize Notes: Blue lines show the simulation of transition path after a reduction of automation cost, red lines show the transition with a 1\% automation tax, yellow liens show the transition with a 0.7\% training tax on skilled workers. Oscillations are caused by the computational errors.}
\end{figure}

Figure \ref{transition3} plots the transition path with a 1\% automation tax (blue lines) or a 0.7\% training tax (red lines) on skilled workers, which renders the same fiscal revenue as the automation tax. 
